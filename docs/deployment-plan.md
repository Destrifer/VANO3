...
- ⏳ Остаток: уведомления (Telegram/SMTP), off-site бэкапов, снять noindex на запуске, почистить 5 дев-заказов.
